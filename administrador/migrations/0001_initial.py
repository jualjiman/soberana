    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateField(default=datetime.datetime(2015, 2, 10, 11, 33, 11, 203946), help_text=b'Fecha a partir de la cual sera mostrada la publicacion')),
                ('fecha_inicio', models.DateTimeField(default=datetime.datetime(2015, 2, 10, 11, 33, 11, 203982), help_text=b'Fecha y hora de inicio de la publicacion')),
                ...
                ('categoria', models.IntegerField(help_text=b'Define la prioridad de la publicacion', choices=[(1, 'Importante'), (0, 'Normal')])),
